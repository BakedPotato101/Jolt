...
export default function Home() {
  return (
    <div className="bg-white dark:bg-slate-900 w-full h-full pt-20 flex flex-col items-center justify-center dark:text-white" style={{ backgroundImage: 'url("OIP (2).jpeg")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
