...
import { faHome, faUsers, faUserTie, faUser } from '@fortawesome/free-solid-svg-icons';
export default function Sidebar() {
  return (
    <div className="bg-slate-700 h-screen w-20 flex-row items-center justify-normal">
      ...
      <Link href="/coaches"><FontAwesomeIcon className="pt-40 w-full size-12 text-white" icon={ faUserTie}/></Link>
    </div>
  );
}